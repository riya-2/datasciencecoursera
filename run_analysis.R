...
# Download the required data from the URL
...
#unzip(zipfile = "./getcleandata/projectdataset.zip", exdir = "./getcleandata") #Unzip the file


# 1. Merge the training and test datasets
# 1.1 Reading files

# 1.1.1 Reading training datasets from the local due to internet issue
setwd("C:/Users/Documents/datasciencecoursera/UCI HAR Dataset/train/")
x_train <- read.table("X_train.txt")
y_train <- read.table("y_train.txt")
subject_train <- read.table("subject_train.txt")

# 1.1.2 Reading test datasets
setwd("C:/Users/Documents/datasciencecoursera/UCI HAR Dataset/test/")
x_test <- read.table("X_test.txt")
y_test <- read.table("y_test.txt")
subject_test <- read.table("subject_test.txt")

# 1.1.3 Reading feature vector
setwd("C:/Users/Documents/datasciencecoursera/UCI HAR Dataset/")
